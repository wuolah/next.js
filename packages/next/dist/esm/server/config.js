...
import { basename, extname, join, relative, isAbsolute, resolve, dirname } from "path";
...
function assignDefaults(dir, userConfig, silent = false) {
    var _result_experimental, _result_experimental1, _userConfig_experimental, _result_experimental2, _result_experimental3, _result_experimental4, _result_devIndicators;
    ...
    if (typeof ((_userConfig_experimental = userConfig.experimental) == null ? void 0 : _userConfig_experimental.clientRouterFilter) === "undefined" && ((_result_experimental2 = result.experimental) == null ? void 0 : _result_experimental2.appDir)) {
    ...
    if (!((_result_experimental4 = result.experimental) == null ? void 0 : _result_experimental4.outputFileTracingRoot)) {
        ...
        const foundLockfile = findUp.sync(lockFiles, {
            cwd: dir
        });
        if (foundLockfile) {
            if (!result.experimental) {
