...
import { hydrationErrorComponentStack, hydrationErrorWarning, patchConsoleError, } from 'next/dist/client/components/react-dev-overlay/internal/helpers/hydration-error-info';
...
function onUnhandledError(ev) {
    ...
    const e = error;
    const componentStack = typeof hydrationErrorComponentStack === 'string'
        ? parseComponentStack(hydrationErrorComponentStack).map((frame) => frame.component)
        : undefined;
    Bus.emit({
