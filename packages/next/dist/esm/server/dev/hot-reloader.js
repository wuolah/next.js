                ...
                await Promise.all(Object.keys(entries).map(async (entryKey)=>{
                    ...
                    await runDependingOnPageType({
                        ...
                        onServer: ()=>{
                            ...
                            } else if (!isAPIRoute(page) && !isMiddlewareFile(page) && !isInternalPathname(relativeRequest)) {
                                ...
                                if (chunk.id === key) {
                                    ...
                                    modsIterable.forEach((mod)=>{
                                        ...
                                        pageExtensionRegex.test(mod.resource)) {
                                            ...
                                            if (mod.layer === WEBPACK_LAYERS.server && (mod == null ? void 0 : (_mod_buildInfo = mod.buildInfo) == null ? void 0 : (_mod_buildInfo_rsc = _mod_buildInfo.rsc) == null ? void 0 : _mod_buildInfo_rsc.type) !== "client") {
                                            ...
                                            if (mod.layer === WEBPACK_LAYERS.server && (mod == null ? void 0 : (_mod_buildInfo1 = mod.buildInfo) == null ? void 0 : (_mod_buildInfo_rsc1 = _mod_buildInfo1.rsc) == null ? void 0 : _mod_buildInfo_rsc1.type) !== "client") {
                                                chunksHashServerLayer.add(hash);
                                            }
                                            chunksHash.add(hash);
