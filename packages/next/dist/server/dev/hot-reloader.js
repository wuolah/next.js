...
const _isinternalpathname = require("../../lib/is-internal-pathname");
...
class HotReloader {
    ...
    onHMR(req, _res, head) {
        wsServer.handleUpgrade(req, req.socket, head, (client)=>{
            ...
            (_this_onDemandEntries = this.onDemandEntries) == null ? void 0 : _this_onDemandEntries.onHMR(client);
                ...
                await Promise.all(Object.keys(entries).map(async (entryKey)=>{
                    ...
                    await (0, _entries.runDependingOnPageType)({
                        ...
                        onServer: ()=>{
                            ...
                            } else if (!(0, _isapiroute.isAPIRoute)(page) && !(0, _utils.isMiddlewareFile)(page) && !(0, _isinternalpathname.isInternalPathname)(relativeRequest)) {
                                ...
                                if (chunk.id === key) {
                                    ...
                                    modsIterable.forEach((mod)=>{
                                        ...
                                        pageExtensionRegex.test(mod.resource)) {
                                            ...
                                            if (mod.layer === _constants.WEBPACK_LAYERS.server && (mod == null ? void 0 : (_mod_buildInfo = mod.buildInfo) == null ? void 0 : (_mod_buildInfo_rsc = _mod_buildInfo.rsc) == null ? void 0 : _mod_buildInfo_rsc.type) !== "client") {
                                            ...
                                            if (mod.layer === _constants.WEBPACK_LAYERS.server && (mod == null ? void 0 : (_mod_buildInfo1 = mod.buildInfo) == null ? void 0 : (_mod_buildInfo_rsc1 = _mod_buildInfo1.rsc) == null ? void 0 : _mod_buildInfo_rsc1.type) !== "client") {
                                                chunksHashServerLayer.add(hash);
                                            }
                                            chunksHash.add(hash);
