...
const _discover = require("./webpack/loaders/metadata/discover");
...
const asyncStoragesRegex = /next[\\/]dist[\\/]client[\\/]components[\\/](static-generation-async-storage|action-async-storage|request-async-storage)/;
...
function createReactAliases(bundledReactChannel, opts) {
    const alias = {
...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , originalRewrites , originalRedirects , runWebpackSpan , appDir , middlewareMatchers , noMangling =false , jsConfig , resolvedBaseUrl , supportedBrowsers , clientRouterFilters , previewModeId , fetchCacheKeyPrefix , allowedRevalidateHeaderKeys  }) {
    ...
    const reactServerCondition = [
        "react-server",
        ...mainFieldsPerCompiler[isEdgeServer ? _constants1.COMPILER_NAMES.edgeServer : _constants1.COMPILER_NAMES.server],
        "node",
        "import",
        "require"
    ];
    ...
    const resolveConfig = {
        ...
        alias: {
            ...
            ...isEdgeServer ? {
                ...
                [require.resolve("next/dist/client/link")]: "next/dist/esm/client/link",
                [require.resolve("next/dist/client/image")]: "next/dist/esm/client/image",
                [require.resolve("next/dist/client/script")]: "next/dist/esm/client/script",
                [require.resolve("next/dist/client/router")]: "next/dist/esm/client/router",
                [require.resolve("next/dist/shared/lib/head")]: "next/dist/esm/shared/lib/head",
                [require.resolve("next/dist/shared/lib/dynamic")]: "next/dist/esm/shared/lib/dynamic",
                [require.resolve("next/dist/pages/_document")]: "next/dist/esm/pages/_document",
                [require.resolve("next/dist/pages/_app")]: "next/dist/esm/pages/_app",
                [require.resolve("next/dist/client/components/navigation")]: "next/dist/client/components/navigation",
                [require.resolve("next/dist/client/components/headers")]: "next/dist/client/components/headers"
            } : undefined,
        ...
        ...isEdgeServer && {
            conditionNames: [
                ...mainFieldsPerCompiler[_constants1.COMPILER_NAMES.edgeServer],
                "import",
                "node"
            ]
        },
    ...
    async function handleExternals(context, request, dependencyType, layer, getResolve) {
        ...
        const isAppLayer = [
            ...
            _constants.WEBPACK_LAYERS.action
        ].includes(layer);
        ...
        if (!isLocal) {
            ...
            if (reactPackagesRegex.test(request)) {
                ...
                if (request === "react-dom" && (layer === _constants.WEBPACK_LAYERS.client || layer === _constants.WEBPACK_LAYERS.server || layer === _constants.WEBPACK_LAYERS.action)) {
        ...
        if (layer === _constants.WEBPACK_LAYERS.server && request === "next/dist/compiled/@vercel/og/index.node.js") {
    ...
    let webpackConfig = {
        ...
        module: {
            rules: [
                ...
                ...hasServerComponents ? [
                    ...
                    {
                        test: codeCondition.test,
                        issuerLayer: _constants.WEBPACK_LAYERS.appClient,
                        resolve: {
                            alias: {
                                ...createReactAliases(bundledReactChannel, {
                ...
                ...!config.images.disableStaticImages ? [
                    {
                        ...
                        resourceQuery: {
                            not: [
                                _discover.METADATA_RESOURCE_QUERY
                            ]
                        },
                        options: {
                            isServer: isNodeServer || isEdgeServer,
        ...
        plugins: [
            ...
            hasServerComponents && (isClient ? new _flightmanifestplugin.ClientReferenceManifestPlugin({
                dev,
                appDir
            }) : new _flightcliententryplugin.ClientReferenceEntryPlugin({
                appDir,
                dev,
                isEdgeServer,
    ...
    if (dev) {
        ...
        webpack5Config.module.unsafeCache = (module1)=>!/[\\/]pages[\\/][^\\/]+(?:$|\?|#)/.test(module1.resource);
    }
    ...
    const cache = {
        ...
        version: `${"13.4.4-canary.2"}|${configVars}`,
